...
/**
 * EXAMPLE: Onsite page with full G4-G8 features including sun simulation
 *
 * To use:
 * 1. Replace OnSiteCanvas import with OnSiteCanvasWithLights
 * 2. Add sunState management
 * 3. Add SunControls to sidebar
 * 4. Pass enableSun={true} to canvas
 */
  ...
  return (
    <section className="grid-container py-12">
      ...
      <div className="mb-6">
        ...
        <p className="text-ink-muted text-sm">On-Site Placement with Sun Simulation</p>
      </div>
